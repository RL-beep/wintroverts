...
teammate_json_path = os.path.join(script_directory, 'teammate_appearances_counts.json')
...
opponent_json_path = os.path.join(script_directory, 'opponent_appearances_counts.json')
